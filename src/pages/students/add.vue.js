    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                query = event.query;
                _a = filteredClasses;
                return [4 /*yield*/, classService_1.classService.autocompleteClasses(query)];
            case 1:
                _a.value = _b.sent();
                return [2 /*return*/];
        }
...
/** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ value: (__VLS_ctx.form.name), type: "text" }, { class: "input input-bordered focus:border-secondary rounded-xl" }), { required: true, placeholder: "Jane Doe" }));
/** @type {__VLS_StyleScopedClasses['input']} */ ;
/** @type {__VLS_StyleScopedClasses['input-bordered']} */ ;
/** @type {__VLS_StyleScopedClasses['focus:border-secondary']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "form-control" }));
/** @type {__VLS_StyleScopedClasses['form-control']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.label, __VLS_intrinsics.label)(__assign({ class: "label" }));
...
/** @type {__VLS_StyleScopedClasses['label-text']} */ ;
/** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ value: (__VLS_ctx.form.nis), type: "text" }, { class: "input input-bordered focus:border-secondary rounded-xl" }), { required: true, placeholder: "12345678" }));
/** @type {__VLS_StyleScopedClasses['input']} */ ;
/** @type {__VLS_StyleScopedClasses['input-bordered']} */ ;
/** @type {__VLS_StyleScopedClasses['focus:border-secondary']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
...
/** @type {__VLS_StyleScopedClasses['label-text']} */ ;
/** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ value: (__VLS_ctx.form.gender) }, { class: "select select-bordered focus:border-secondary rounded-xl" }), { required: true }));
...
// @ts-ignore
var __VLS_6 = __VLS_asFunctionalComponent1(__VLS_5, new __VLS_5(__assign(__assign(__assign({ 'onComplete': {} }, { modelValue: (__VLS_ctx.form.class_name), suggestions: (__VLS_ctx.filteredClasses), optionLabel: "name", placeholder: "Search Class (min. 3 chars)", delay: (300) }), { class: "w-full" }), { inputClass: "input input-bordered focus:border-secondary rounded-xl w-full", panelClass: "bg-base-100 border shadow-xl rounded-xl mt-1 z-50 text-sm menu p-2" })));
var __VLS_7 = __VLS_6.apply(void 0, __spreadArray([__assign(__assign(__assign({ 'onComplete': {} }, { modelValue: (__VLS_ctx.form.class_name), suggestions: (__VLS_ctx.filteredClasses), optionLabel: "name", placeholder: "Search Class (min. 3 chars)", delay: (300) }), { class: "w-full" }), { inputClass: "input input-bordered focus:border-secondary rounded-xl w-full", panelClass: "bg-base-100 border shadow-xl rounded-xl mt-1 z-50 text-sm menu p-2" })], __VLS_functionalComponentArgsRest(__VLS_6), false));
var __VLS_10;
...
/** @type {__VLS_StyleScopedClasses['label-text']} */ ;
/** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.select, __VLS_intrinsics.select)(__assign(__assign({ value: (__VLS_ctx.form.enrollment_status) }, { class: "select select-bordered focus:border-secondary rounded-xl" }), { required: true }));
/** @type {__VLS_StyleScopedClasses['select']} */ ;
/** @type {__VLS_StyleScopedClasses['select-bordered']} */ ;
/** @type {__VLS_StyleScopedClasses['focus:border-secondary']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
...
/** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
/** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ type: "submit" }, { class: "btn btn-secondary rounded-xl font-bold px-8 shadow-lg shadow-secondary/20" }), { disabled: (__VLS_ctx.isSubmitting) }));
/** @type {__VLS_StyleScopedClasses['btn']} */ ;
...
// @ts-ignore
[i18n, i18n, i18n, goBack, goBack, handleSubmit, form, form, form, form, form, filteredClasses, searchClass, isSubmitting, isSubmitting, isSubmitting,];
