...
var openEditForm = function (id) {
    router.push("/students/edit/".concat(id));
};
...
var handleStatusToggle = function (id, currentStatus) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.toggleItemStatus(id, 'enrollment_status', newStatus)];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
...
var itemsPerPage = 10;
var filteredStudents = (0, vue_2.computed)(function () {
    return store.items.filter(function (s) {
...
var paginatedStudents = (0, vue_2.computed)(function () {
...
/** @type {__VLS_StyleScopedClasses['text-base-content']} */ ;
/** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ onClick: (__VLS_ctx.openAddForm) }, { class: "btn btn-secondary rounded-xl px-6 font-bold gap-2 shadow-lg shadow-secondary/20 capitalize" }));
/** @type {__VLS_StyleScopedClasses['btn']} */ ;
...
/** @type {__VLS_StyleScopedClasses['shadow-secondary/20']} */ ;
...
(__VLS_ctx.i18n.actions.register);
...
if (__VLS_ctx.store.loadingList) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "loading loading-spinner text-secondary loading-lg" }));
    ...
    var _loop_1 = function (student) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)(__assign({ key: (student.id) }, { class: "border-b border-base-content/5 last:border-0 hover:bg-base-content/[0.02] transition-colors" }));
        /** @type {__VLS_StyleScopedClasses['border-b']} */ ;
        /** @type {__VLS_StyleScopedClasses['border-base-content/5']} */ ;
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "bg-secondary/10 text-secondary font-black rounded-xl w-10 shadow-sm border border-secondary/20 uppercase" }));
        ...
        /** @type {__VLS_StyleScopedClasses['shadow-sm']} */ ;
        /** @type {__VLS_StyleScopedClasses['border']} */ ;
        /** @type {__VLS_StyleScopedClasses['border-secondary/20']} */ ;
        /** @type {__VLS_StyleScopedClasses['uppercase']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['py-10']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: ("badge badge-sm font-black uppercase text-[10px] p-2 h-auto ".concat(student.enrollment_status === 'Active'
        ...
        /** @type {__VLS_StyleScopedClasses['items-center']} */ ;
        /** @type {__VLS_StyleScopedClasses['gap-3']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: (function () { return __VLS_ctx.openEditForm(student.id || 0); }) }, { class: "btn btn-ghost btn-sm btn-circle text-base-content opacity-40 hover:opacity-100 transition-opacity" }), { title: "Edit Student" }));
        /** @type {__VLS_StyleScopedClasses['btn']} */ ;
        /** @type {__VLS_StyleScopedClasses['btn-ghost']} */ ;
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign(__assign({ onChange: function () {
                ...
                if (!!(__VLS_ctx.store.loadingList))
                    return;
                __VLS_ctx.handleStatusToggle(student.id || 0, student.enrollment_status);
                // @ts-ignore
                [i18n, i18n, i18n, i18n, i18n, i18n, i18n, searchQuery, openAddForm, store, paginatedStudents, openEditForm, handleStatusToggle,];
            } }, { type: "checkbox" }), { class: "toggle toggle-sm toggle-success" }), { checked: (__VLS_ctx.isStatusActive(student.enrollment_status)), title: "Toggle Enrollment Status" }));
    ...
    for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.paginatedStudents)); _i < _a.length; _i++) {
        var student = _a[_i][0];
        _loop_1(student);
    }
    if (__VLS_ctx.paginatedStudents.length === 0) {
...
if (!__VLS_ctx.store.loadingList && __VLS_ctx.store.items.length > 0) {
    ...
    (__VLS_ctx.paginatedStudents.length);
    (__VLS_ctx.i18n.pagination.of);
    (__VLS_ctx.filteredStudents.length);
    (__VLS_ctx.i18n.pagination.students);
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign({ class: "btn btn-ghost join-item btn-sm text-secondary font-black px-4" }));
    /** @type {__VLS_StyleScopedClasses['btn']} */ ;
    /** @type {__VLS_StyleScopedClasses['btn-ghost']} */ ;
    /** @type {__VLS_StyleScopedClasses['join-item']} */ ;
    /** @type {__VLS_StyleScopedClasses['btn-sm']} */ ;
...
// @ts-ignore
[i18n, i18n, i18n, i18n, i18n, currentPage, currentPage, currentPage, searchQuery, store, store, paginatedStudents, paginatedStudents, filteredStudents, prevPage, nextPage, totalPages,];
