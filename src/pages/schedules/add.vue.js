    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                finalPayload = __assign(__assign({}, form.value), { class_name: typeof form.value.class_name === 'object' ? form.value.class_name.name : form.value.class_name, period_duration: "".concat(startTime.value, " - ").concat(endTime.value), instructor: typeof form.value.instructor === 'object' ? form.value.instructor.name : form.value.instructor, subject: typeof form.value.subject === 'object' ? form.value.subject.name : form.value.subject });
...
// @ts-ignore
[i18n, i18n, i18n, goBack, goBack, handleSubmit, form, form, form, form, filteredClasses, searchClass, startTime, endTime, filteredTeachers, searchTeacher, filteredSubjects, searchSubject, isSubmitting, isSubmitting, isSubmitting,];
