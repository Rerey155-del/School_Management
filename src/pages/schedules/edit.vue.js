...
var useScheduleStore_1 = require("@/stores/useScheduleStore");
...
var store = (0, useScheduleStore_1.useScheduleStore)();
...
var startTime = (0, vue_2.ref)("");
var endTime = (0, vue_2.ref)("");
/* Autocomplete */
...
var filteredTeachers = (0, vue_2.ref)([]);
var searchTeacher = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = filteredTeachers;
                return [4 /*yield*/, teacherService_1.teacherService.autocompleteTeachers(event.query)];
            case 1:
                _a.value = _b.sent();
                return [2 /*return*/];
        }
...
var filteredSubjects = (0, vue_2.ref)([]);
var searchSubject = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = filteredSubjects;
                return [4 /*yield*/, subjectService_1.subjectService.autocompleteSubjects(event.query)];
            case 1:
                _a.value = _b.sent();
                return [2 /*return*/];
        }
...
(0, vue_2.onMounted)(function () { return __awaiter(void 0, void 0, void 0, function () {
    var id, fetchPromise, detail, times;
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (detail.period_duration) {
                    times = detail.period_duration.split(" - ");
...
var handleSubmit = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, payloadTemp, payload, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, 3, 4]);
                isSubmitting.value = true;
                _a = form.value, id = _a.id, payloadTemp = __rest(_a, ["id"]);
                payload = __assign(__assign({}, payloadTemp), { class_name: typeof payloadTemp.class_name === "object"
                        ? payloadTemp.class_name.name
                        : payloadTemp.class_name, period_duration: "".concat(startTime.value, " - ").concat(endTime.value), instructor: typeof payloadTemp.instructor === "object"
                        ? payloadTemp.instructor.name
                        : payloadTemp.instructor, subject: typeof payloadTemp.subject === "object"
                        ? payloadTemp.subject.name
                        : payloadTemp.subject });
                return [4 /*yield*/, store.updateItem(id, payload)];
            case 1:
                _b.sent();
                router.push("/schedules");
                return [3 /*break*/, 4];
...
if (__VLS_ctx.showSkeleton) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "h-3 w-32 bg-base-200 rounded" }));
    ...
    /** @type {__VLS_StyleScopedClasses['flex']} */ ;
    /** @type {__VLS_StyleScopedClasses['gap-3']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "h-12 bg-base-200 rounded-xl w-full" }));
    /** @type {__VLS_StyleScopedClasses['h-12']} */ ;
    /** @type {__VLS_StyleScopedClasses['bg-base-200']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "space-y-2" }));
    /** @type {__VLS_StyleScopedClasses['space-y-2']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "h-3 w-36 bg-base-200 rounded" }));
    /** @type {__VLS_StyleScopedClasses['h-3']} */ ;
    ...
    /** @type {__VLS_StyleScopedClasses['bg-base-200']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "flex justify-end gap-3 pt-4" }));
    /** @type {__VLS_StyleScopedClasses['flex']} */ ;
    /** @type {__VLS_StyleScopedClasses['justify-end']} */ ;
    /** @type {__VLS_StyleScopedClasses['gap-3']} */ ;
    /** @type {__VLS_StyleScopedClasses['pt-4']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "h-10 w-24 bg-base-200 rounded-xl" }));
    /** @type {__VLS_StyleScopedClasses['h-10']} */ ;
    /** @type {__VLS_StyleScopedClasses['w-24']} */ ;
    /** @type {__VLS_StyleScopedClasses['bg-base-200']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "h-10 w-36 bg-base-200 rounded-xl" }));
    /** @type {__VLS_StyleScopedClasses['h-10']} */ ;
    /** @type {__VLS_StyleScopedClasses['w-36']} */ ;
    /** @type {__VLS_StyleScopedClasses['bg-base-200']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    ...
    // @ts-ignore
    var __VLS_6 = __VLS_asFunctionalComponent1(__VLS_5, new __VLS_5(__assign(__assign(__assign({ 'onComplete': {} }, { modelValue: (__VLS_ctx.form.class_name), suggestions: (__VLS_ctx.filteredClasses), optionLabel: "name", placeholder: "Search Class (e.g., Grade 10A)", delay: (300) }), { class: "w-full" }), { inputClass: "input input-bordered focus:border-primary rounded-xl w-full", panelClass: "bg-base-100 border shadow-xl rounded-xl mt-1 z-50 text-sm menu p-2" })));
    var __VLS_7 = __VLS_6.apply(void 0, __spreadArray([__assign(__assign(__assign({ 'onComplete': {} }, { modelValue: (__VLS_ctx.form.class_name), suggestions: (__VLS_ctx.filteredClasses), optionLabel: "name", placeholder: "Search Class (e.g., Grade 10A)", delay: (300) }), { class: "w-full" }), { inputClass: "input input-bordered focus:border-primary rounded-xl w-full", panelClass: "bg-base-100 border shadow-xl rounded-xl mt-1 z-50 text-sm menu p-2" })], __VLS_functionalComponentArgsRest(__VLS_6), false));
    var __VLS_10 = void 0;
    ...
    /** @type {__VLS_StyleScopedClasses['label-text']} */ ;
    /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ type: "date" }, { class: "input input-bordered focus:border-primary rounded-xl" }), { required: true }));
    (__VLS_ctx.form.day);
    ...
    /** @type {__VLS_StyleScopedClasses['items-center']} */ ;
    /** @type {__VLS_StyleScopedClasses['gap-3']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ type: "time" }, { class: "input input-bordered focus:border-primary rounded-xl w-full" }), { required: true }));
    (__VLS_ctx.startTime);
    /** @type {__VLS_StyleScopedClasses['input']} */ ;
    /** @type {__VLS_StyleScopedClasses['input-bordered']} */ ;
    /** @type {__VLS_StyleScopedClasses['focus:border-primary']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    /** @type {__VLS_StyleScopedClasses['w-full']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "font-bold text-base-content/40" }));
    /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
    /** @type {__VLS_StyleScopedClasses['text-base-content/40']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ type: "time" }, { class: "input input-bordered focus:border-primary rounded-xl w-full" }), { required: true }));
    (__VLS_ctx.endTime);
    ...
    autocomplete_1.default;
    // @ts-ignore
    var __VLS_13 = __VLS_asFunctionalComponent1(__VLS_12, new __VLS_12(__assign(__assign(__assign({ 'onComplete': {} }, { modelValue: (__VLS_ctx.form.instructor), suggestions: (__VLS_ctx.filteredTeachers), optionLabel: "name", placeholder: "Search Instructor (e.g., Mr. Wilson)", delay: (300) }), { class: "w-full" }), { inputClass: "input input-bordered focus:border-primary rounded-xl w-full", panelClass: "bg-base-100 border shadow-xl rounded-xl mt-1 z-50 text-sm menu p-2" })));
    var __VLS_14 = __VLS_13.apply(void 0, __spreadArray([__assign(__assign(__assign({ 'onComplete': {} }, { modelValue: (__VLS_ctx.form.instructor), suggestions: (__VLS_ctx.filteredTeachers), optionLabel: "name", placeholder: "Search Instructor (e.g., Mr. Wilson)", delay: (300) }), { class: "w-full" }), { inputClass: "input input-bordered focus:border-primary rounded-xl w-full", panelClass: "bg-base-100 border shadow-xl rounded-xl mt-1 z-50 text-sm menu p-2" })], __VLS_functionalComponentArgsRest(__VLS_13), false));
    var __VLS_17 = void 0;
    var __VLS_18 = ({ complete: {} },
        { onComplete: (__VLS_ctx.searchTeacher) });
    /** @type {__VLS_StyleScopedClasses['w-full']} */ ;
    var __VLS_15;
    var __VLS_16;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "form-control flex flex-col pt-1" }));
    ...
    autocomplete_1.default;
    // @ts-ignore
    var __VLS_20 = __VLS_asFunctionalComponent1(__VLS_19, new __VLS_19(__assign(__assign(__assign({ 'onComplete': {} }, { modelValue: (__VLS_ctx.form.subject), suggestions: (__VLS_ctx.filteredSubjects), optionLabel: "name", placeholder: "Search Subject (e.g., Mathematics)", delay: (300) }), { class: "w-full" }), { inputClass: "input input-bordered focus:border-primary rounded-xl w-full", panelClass: "bg-base-100 border shadow-xl rounded-xl mt-1 z-50 text-sm menu p-2" })));
    var __VLS_21 = __VLS_20.apply(void 0, __spreadArray([__assign(__assign(__assign({ 'onComplete': {} }, { modelValue: (__VLS_ctx.form.subject), suggestions: (__VLS_ctx.filteredSubjects), optionLabel: "name", placeholder: "Search Subject (e.g., Mathematics)", delay: (300) }), { class: "w-full" }), { inputClass: "input input-bordered focus:border-primary rounded-xl w-full", panelClass: "bg-base-100 border shadow-xl rounded-xl mt-1 z-50 text-sm menu p-2" })], __VLS_functionalComponentArgsRest(__VLS_20), false));
    var __VLS_24 = void 0;
    var __VLS_25 = ({ complete: {} },
        { onComplete: (__VLS_ctx.searchSubject) });
    /** @type {__VLS_StyleScopedClasses['w-full']} */ ;
    var __VLS_22;
    var __VLS_23;
...
var __VLS_26 = Sidebar_vue_1.default;
// @ts-ignore
...
// @ts-ignore
[i18n, i18n, i18n, goBack, goBack, showSkeleton, handleSubmit, form, form, form, form, filteredClasses, searchClass, startTime, endTime, filteredTeachers, searchTeacher, filteredSubjects, searchSubject, isSubmitting, isSubmitting, isSubmitting,];
