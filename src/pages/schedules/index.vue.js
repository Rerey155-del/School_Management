...
var openEditForm = function (id) {
    router.push("/schedules/edit/".concat(id));
};
var i18n = {
    brand: "SCHOOL",
    version: "V3",
...
var itemsPerPage = 10;
var filteredSchedules = (0, vue_2.computed)(function () {
    return store.items.filter(function (s) {
        return s.class_name.toLowerCase().includes(searchQuery.value.toLowerCase()) ||
...
var totalPages = (0, vue_2.computed)(function () {
    return Math.ceil(filteredSchedules.value.length / itemsPerPage);
});
var paginatedSchedules = (0, vue_2.computed)(function () {
...
vue_1.Icon;
// @ts-ignore
var __VLS_11 = __VLS_asFunctionalComponent1(__VLS_10, new __VLS_10(__assign({ icon: "lucide:calendar-plus" }, { class: "text-sm" })));
var __VLS_12 = __VLS_11.apply(void 0, __spreadArray([__assign({ icon: "lucide:calendar-plus" }, { class: "text-sm" })], __VLS_functionalComponentArgsRest(__VLS_11), false));
...
if (__VLS_ctx.store.loadingList) {
    ...
    /** @type {__VLS_StyleScopedClasses['py-8']} */ ;
    (__VLS_ctx.i18n.table.day);
    __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)(__assign({ class: "py-8" }));
    /** @type {__VLS_StyleScopedClasses['py-8']} */ ;
    (__VLS_ctx.i18n.table.period);
    __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)(__assign({ class: "py-8" }));
    /** @type {__VLS_StyleScopedClasses['py-8']} */ ;
    (__VLS_ctx.i18n.table.instructor);
    __VLS_asFunctionalElement1(__VLS_intrinsics.th, __VLS_intrinsics.th)(__assign({ class: "py-8" }));
    /** @type {__VLS_StyleScopedClasses['py-8']} */ ;
    (__VLS_ctx.i18n.table.subject);
    ...
    var _loop_1 = function (sch) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)(__assign({ key: (sch.id) }, { class: "border-b border-base-content/5 last:border-0 hover:bg-base-content/[0.02] transition-colors" }));
        /** @type {__VLS_StyleScopedClasses['border-b']} */ ;
        /** @type {__VLS_StyleScopedClasses['border-base-content/5']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['py-10']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign({ class: "px-5 py-2.5 bg-primary/10 text-primary rounded-xl font-bold text-xs border border-primary/20" }));
        ...
        (sch.period_duration);
        __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ class: "py-10 text-lg font-medium text-base-content/70" }));
        /** @type {__VLS_StyleScopedClasses['py-10']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-lg']} */ ;
        /** @type {__VLS_StyleScopedClasses['font-medium']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-base-content/70']} */ ;
        (sch.instructor);
        __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ class: "py-10 font-bold text-lg text-[#6366f1]" }));
        /** @type {__VLS_StyleScopedClasses['py-10']} */ ;
        /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-lg']} */ ;
        /** @type {__VLS_StyleScopedClasses['text-[#6366f1]']} */ ;
        (sch.subject);
        ...
        /** @type {__VLS_StyleScopedClasses['items-center']} */ ;
        /** @type {__VLS_StyleScopedClasses['gap-3']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: (function () { return __VLS_ctx.openEditForm(sch.id || 0); }) }, { class: "btn btn-ghost btn-sm btn-circle text-base-content opacity-40 hover:opacity-100 transition-opacity" }), { title: "Edit Schedule" }));
        /** @type {__VLS_StyleScopedClasses['btn']} */ ;
        /** @type {__VLS_StyleScopedClasses['btn-ghost']} */ ;
        ...
        // @ts-ignore
        [i18n, i18n, i18n, i18n, i18n, i18n, i18n, i18n, searchQuery, openAddForm, store, paginatedSchedules, openEditForm,];
    };
    for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.paginatedSchedules)); _i < _a.length; _i++) {
        var sch = _a[_i][0];
        _loop_1(sch);
    }
    if (__VLS_ctx.paginatedSchedules.length === 0) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)({});
        __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ colspan: "8" }, { class: "py-20 text-center text-base-content/20 font-bold italic" }));
...
if (!__VLS_ctx.store.loadingList && __VLS_ctx.store.items.length > 0) {
    ...
    (__VLS_ctx.paginatedSchedules.length);
    (__VLS_ctx.i18n.pagination.of);
    (__VLS_ctx.filteredSchedules.length);
    (__VLS_ctx.i18n.pagination.schedules);
...
// @ts-ignore
[i18n, i18n, i18n, i18n, i18n, currentPage, currentPage, currentPage, searchQuery, store, store, paginatedSchedules, paginatedSchedules, filteredSchedules, prevPage, nextPage, totalPages,];
