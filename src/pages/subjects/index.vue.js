...
var openEditForm = function (id) {
    router.push("/subjects/edit/".concat(id));
};
...
var itemsPerPage = 10;
var filteredSubjects = (0, vue_2.computed)(function () {
    return store.items.filter(function (s) {
        return s.subject_name.toLowerCase().includes(searchQuery.value.toLowerCase());
    });
});
var totalPages = (0, vue_2.computed)(function () {
    return Math.ceil(filteredSubjects.value.length / itemsPerPage);
});
var paginatedSubjects = (0, vue_2.computed)(function () {
...
if (__VLS_ctx.store.loadingList) {
    ...
    var _loop_1 = function (sub) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.tr, __VLS_intrinsics.tr)(__assign({ key: (sub.id) }, { class: "border-b border-base-content/5 last:border-0 hover:bg-base-content/[0.02] transition-colors" }));
        /** @type {__VLS_StyleScopedClasses['border-b']} */ ;
        /** @type {__VLS_StyleScopedClasses['border-base-content/5']} */ ;
        /** @type {__VLS_StyleScopedClasses['last:border-0']} */ ;
        /** @type {__VLS_StyleScopedClasses['hover:bg-base-content/[0.02]']} */ ;
        /** @type {__VLS_StyleScopedClasses['transition-colors']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.td, __VLS_intrinsics.td)(__assign({ class: "pl-12 py-10 font-bold text-lg text-primary" }));
        /** @type {__VLS_StyleScopedClasses['pl-12']} */ ;
        ...
        /** @type {__VLS_StyleScopedClasses['items-center']} */ ;
        /** @type {__VLS_StyleScopedClasses['gap-3']} */ ;
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: (function () { return __VLS_ctx.openEditForm(sub.id || 0); }) }, { class: "btn btn-ghost btn-sm btn-circle text-base-content opacity-40 hover:opacity-100 transition-opacity" }), { title: "Edit Subject" }));
        /** @type {__VLS_StyleScopedClasses['btn']} */ ;
        /** @type {__VLS_StyleScopedClasses['btn-ghost']} */ ;
        ...
        // @ts-ignore
        [i18n, i18n, i18n, i18n, i18n, searchQuery, openAddForm, store, paginatedSubjects, openEditForm,];
    };
    for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.paginatedSubjects)); _i < _a.length; _i++) {
        var sub = _a[_i][0];
        _loop_1(sub);
    }
    if (__VLS_ctx.paginatedSubjects.length === 0) {
...
if (!__VLS_ctx.store.loadingList && __VLS_ctx.store.items.length > 0) {
    ...
    (__VLS_ctx.paginatedSubjects.length);
    (__VLS_ctx.i18n.pagination.of);
    (__VLS_ctx.filteredSubjects.length);
    (__VLS_ctx.i18n.pagination.subjects);
...
// @ts-ignore
[i18n, i18n, i18n, i18n, i18n, currentPage, currentPage, currentPage, searchQuery, store, store, paginatedSubjects, paginatedSubjects, filteredSubjects, prevPage, nextPage, totalPages,];
