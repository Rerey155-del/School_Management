...
var useSubjectStore_1 = require("@/stores/useSubjectStore");
var vue_2 = require("vue");
var vue_router_1 = require("vue-router");
var store = (0, useSubjectStore_1.useSubjectStore)();
...
(0, vue_2.onMounted)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = route.params.id;
                return [4 /*yield*/, store.fetchDetail(id)];
            case 1:
                detail = _a.sent();
                if (detail) {
                    form.value = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                finalPayload = __assign(__assign({}, form.value), { metadata: metadataInput.value.split(",").map(function (t) { return t.trim(); }).filter(Boolean) });
...
if (__VLS_ctx.store.loadingDetail) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "animate-pulse space-y-6" }));
    /** @type {__VLS_StyleScopedClasses['animate-pulse']} */ ;
    /** @type {__VLS_StyleScopedClasses['space-y-6']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "h-10 bg-base-200 rounded w-1/4" }));
    ...
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    /** @type {__VLS_StyleScopedClasses['w-full']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "h-12 bg-base-200 rounded-xl w-1/2" }));
    /** @type {__VLS_StyleScopedClasses['h-12']} */ ;
    /** @type {__VLS_StyleScopedClasses['bg-base-200']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    /** @type {__VLS_StyleScopedClasses['w-1/2']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "h-12 bg-base-200 rounded-xl w-full mt-8" }));
    /** @type {__VLS_StyleScopedClasses['h-12']} */ ;
    /** @type {__VLS_StyleScopedClasses['bg-base-200']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    /** @type {__VLS_StyleScopedClasses['w-full']} */ ;
    ...
    /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ value: (__VLS_ctx.form.subject_name), type: "text" }, { class: "input input-bordered focus:border-primary rounded-xl" }), { required: true, placeholder: "Mathematics" }));
    ...
    /** @type {__VLS_StyleScopedClasses['label-text']} */ ;
    /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ value: (__VLS_ctx.form.academic_code), type: "text" }, { class: "input input-bordered focus:border-primary rounded-xl" }), { required: true, placeholder: "MAT101" }));
    /** @type {__VLS_StyleScopedClasses['input']} */ ;
    /** @type {__VLS_StyleScopedClasses['input-bordered']} */ ;
    /** @type {__VLS_StyleScopedClasses['focus:border-primary']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    ...
    /** @type {__VLS_StyleScopedClasses['label-text']} */ ;
    /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ value: (__VLS_ctx.metadataInput), type: "text" }, { class: "input input-bordered focus:border-primary rounded-xl" }), { placeholder: "Core, Science, Grade 10" }));
    /** @type {__VLS_StyleScopedClasses['input']} */ ;
    /** @type {__VLS_StyleScopedClasses['input-bordered']} */ ;
    /** @type {__VLS_StyleScopedClasses['focus:border-primary']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
...
var __VLS_5 = Sidebar_vue_1.default;
// @ts-ignore
...
// @ts-ignore
[i18n, i18n, i18n, goBack, goBack, store, handleSubmit, form, form, metadataInput, isSubmitting, isSubmitting, isSubmitting,];
