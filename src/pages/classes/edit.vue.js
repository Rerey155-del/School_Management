...
var handleSubmit = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, putPayload, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, 3, 4]);
                isSubmitting.value = true;
                _a = form.value, id = _a.id, putPayload = __rest(_a, ["id"]);
...
if (__VLS_ctx.store.loadingDetail) {
    ...
    /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ value: (__VLS_ctx.form.class_designation), type: "text" }, { class: "input input-bordered focus:border-primary rounded-xl" }), { required: true, placeholder: "Grade 10A" }));
    ...
    /** @type {__VLS_StyleScopedClasses['label-text']} */ ;
    /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ value: (__VLS_ctx.form.room_id), type: "text" }, { class: "input input-bordered focus:border-primary rounded-xl" }), { required: true, placeholder: "RM-101" }));
    /** @type {__VLS_StyleScopedClasses['input']} */ ;
    /** @type {__VLS_StyleScopedClasses['input-bordered']} */ ;
    /** @type {__VLS_StyleScopedClasses['focus:border-primary']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    ...
    /** @type {__VLS_StyleScopedClasses['label-text']} */ ;
    /** @type {__VLS_StyleScopedClasses['font-bold']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign({ value: (__VLS_ctx.form.utilization), type: "text" }, { class: "input input-bordered focus:border-primary rounded-xl" }), { required: true, placeholder: "30/40" }));
    /** @type {__VLS_StyleScopedClasses['input']} */ ;
    /** @type {__VLS_StyleScopedClasses['input-bordered']} */ ;
    /** @type {__VLS_StyleScopedClasses['focus:border-primary']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
...
// @ts-ignore
[i18n, i18n, i18n, goBack, goBack, store, handleSubmit, form, form, form, form, isSubmitting, isSubmitting, isSubmitting,];
