...
exports.useSubjectStore = void 0;
 ...
 */
exports.useSubjectStore = (0, pinia_1.defineStore)('subject', {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _a = this;
                            return [4 /*yield*/, subjectService_1.subjectService.getAll()];
                        case 2:
                            _a.items = _b.sent();
                            return [3 /*break*/, 5];
                        case 3:
                            err_1 = _b.sent();
                            this.error = err_1.message || 'Failed to fetch subjects';
                            console.error('SubjectStore[fetchList]:', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, 4, 5]);
                            _a = this;
                            return [4 /*yield*/, subjectService_1.subjectService.getById(id)];
                        case 2:
                            _a.detail = _b.sent();
                            return [2 /*return*/, this.detail];
                        case 3:
                            err_2 = _b.sent();
                            this.error = err_2.message || 'Failed to fetch subject details';
                            console.error("SubjectStore[fetchDetail]: id=".concat(id), err_2);
                            throw err_2;
                        case 4:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, subjectService_1.subjectService.create(payload)];
                        case 2:
                            newItem = _a.sent();
                        ...
                        case 3:
                            err_3 = _a.sent();
                            this.error = err_3.message || 'Failed to create subject';
                            console.error('SubjectStore[createItem]:', err_3);
                            throw err_3;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, subjectService_1.subjectService.update(id, payload)];
                        case 2:
                            updatedItem = _a.sent();
                        ...
                        case 3:
                            err_4 = _a.sent();
                            this.error = err_4.message || 'Failed to update subject';
                            console.error("SubjectStore[updateItem]: id=".concat(id), err_4);
                            throw err_4;
                        case 4: return [2 /*return*/];
                    }
                });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, subjectService_1.subjectService.updateStatus(id, statusField, newValue)];
                        case 2:
                            updatedItem = _a.sent();
                            index = this.items.findIndex(function (i) { return String(i.id) === String(id); });
                            if (index !== -1) {
                        ...
                        case 3:
                            err_5 = _a.sent();
                            this.error = err_5.message || 'Failed to update subject status';
                            console.error("SubjectStore[toggleStatus]: id=".concat(id, ", field=").concat(statusField), err_5);
                            throw err_5;
                        case 4: return [2 /*return*/];
                    }
                });
